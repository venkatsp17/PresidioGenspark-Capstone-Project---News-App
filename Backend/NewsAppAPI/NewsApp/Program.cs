        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddCors(options =>
            {
                options.AddPolicy("AllowSpecificOrigin",
                    builder =>
                    {
                        builder.WithOrigins("http://127.0.0.1:3000", "http://localhost:3000", "http://localhost", "http://127.0.0.1", "https://lively-mud-0c7af2f1e.5.azurestaticapps.net", "https://presidio-frontend-newsapp.vercel.app")
                               .AllowAnyHeader()
                               .AllowAnyMethod()
